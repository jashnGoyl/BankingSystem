...
public class AccountManager {
    ...
    public void creditMoney(long accountNumber) throws SQLException {
        ...
        try {
            ...
            if (accountNumber != 0) {
                ...
                if (resultSet.next()) {
                    String creditQuery = "UPDATE accounts " +
                            "SET balance = balance + ? " +
            ...
            if (sender_account_number != 0 && receiver_account_number != 0) {
                ...
                if (resultSet.next()) {
                    ...
                    if (amount <= current_balance) {
                        ...
                        String debit_query = "UPDATE accounts " +
                                "SET balance = balance - ? " +
                                "WHERE account_number = ?";
                        String credit_query = "UPDATE accounts" +
                                " SET balance = balance + ?" +
                                " WHERE account_number = ?";
    ...
    public void getBalance(long account_number) {
        ...
        String security_pin = scanner.nextLine();
        try {
            PreparedStatement preparedStatement = connection.prepareStatement("SELECT balance FROM accounts" +
                    " WHERE account_number = ? AND security_pin = ?");
